...
namespace KitforgeLabs.UIKit.Editor.Generators
{
    internal static class CatalogGroupCBuilder
    {
        ...
        private static string DailyLoginPath => $"{ResolvePrefabsFolder()}/DailyLoginPopup.prefab";
        private static string LevelCompletePath => $"{ResolvePrefabsFolder()}/LevelCompletePopup.prefab";
        private static string GameOverPath => $"{ResolvePrefabsFolder()}/GameOverPopup.prefab";
        private static string HUDEnergyPath => $"{ResolvePrefabsFolder()}/HUDEnergy.prefab";
        private static string HUDTimerPath => $"{ResolvePrefabsFolder()}/HUDTimer.prefab";
