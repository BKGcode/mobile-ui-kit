...
namespace KitforgeLabs.UIKit.Editor.Hub.Theme
{
    internal sealed class KitforgeThemeStudio
    {
        ...
        {
            var label = new Label("No UIThemeConfig assets found. Reinstall the KitForge Labs UI Kit package (3 themes ship in Runtime/Theme/Presets/), or right-click in Project → Create → KitForge Labs → UI Kit → Theme to create your own.");
