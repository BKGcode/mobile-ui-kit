...
Latest tag: `v0.9.0-alpha` (M4 hardening core packaging — 5 Catalog builders aligned via `CatalogGroupBuilderShared` + ThemedImage runtime contract + Theme presets validated end-to-end + QA Suite editor tool). Next: M3c UX audit (no tag) → `v1.0.0-rc` (M5/RC final triple gate).
